...
defimpl Lister, for: BitString do
  def to_list(string), do: String.split(string)
end

defimpl Lister, for: Atom do
  def to_list(atom), do: Atom.to_string(atom) |> String.split()
end
...
defimpl Lister, for: Float do
  def to_list(float), do: Float.to_string(float) |> String.split()
end

defimpl Lister, for: Date do
  def to_list(date), do: Date.to_string(date) |> String.split()
end
